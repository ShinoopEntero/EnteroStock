...
//ing Entero_Stock.crystalReport;
    ...
    public partial class Sales : Form
    {
        ...
        private void Sales_Load(object sender, EventArgs e)
        {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow rw in dt.Rows)
                        {
                            ...
                            if (isError == false)
                            {
                                ...
                                {
                                    GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : Sales_Load() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx.Message, sqlEx.StackTrace.ToString());
                                }
                            }
                        }
                        FillProductList(dtList);
                        //string str = "select top 1 p.ProductID,p.ProductCode,p.PName,c.CName,pd.Price,p.ProfitPercentage from tbl_Product p inner join tbl_Category c on c.Cid = p.Cid  inner join tbl_PurchaseDetails pd on pd.ProductId = p.ProductID  inner join tbl_PurchaseHeader ph on ph.ReferenceNumber = pd.ReferenceNumber  order by ph.PDate desc";
                        //FillProductList(str);
                        fillTax();
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : Sales_Load() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
        ...
        private void fillTax()
        {
            ...
            try
            {
                ...
                {
                    GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : fillTax() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx.Message, sqlEx.StackTrace.ToString());
                }
            }
            catch (Exception ex)
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : fillTax() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
            ...
            try
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow rw in dt.Rows)
                    {
                        ...
                        DataTable dts = obj.GetData(strSQty, ref isError1, ref sqlEx1);
                        ...
                        {
                            if (isError1 == true)
                                GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : FillProductList() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx1.Message, sqlEx1.StackTrace.ToString());
                            if (isError2 == true)
                                GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : FillProductList() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx2.Message, sqlEx2.StackTrace.ToString());
                        }
                    }

                }
                grd_ProductList.DataSource = dt;
                //grd_ProductList.Columns["ProductId"].Visible = false;
            }
            catch (Exception ex)
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : FillProductList() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void auto()
        {
            ...
            try
            {
                ...
                {
                    GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : auto() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx.Message, sqlEx.StackTrace.ToString());
                }
            }
            catch (Exception ex)
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : auto() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public static string GetUniqueKey(int maxSize)
        {
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : GetUniqueKey() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return "";
            }
        }
        ...
        private void btn_CustomerSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : btn_CustomerSearch_Click() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx.Message, sqlEx.StackTrace.ToString());
                }
            }
            catch (Exception ex)
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : btn_CustomerSearch_Click() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void txt_ProductName_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (isError1 == false)
                {
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow rw in dt.Rows)
                        {
                            ...
                            {
                                GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : txt_ProductName_TextChanged() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx2.Message, sqlEx2.StackTrace.ToString());
                            }
                        }
                        FillProductList(dtList);
                    }
                ...
                {
                    GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : txt_ProductName_TextChanged() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx1.Message, sqlEx1.StackTrace.ToString());
                }
            }
            catch (Exception ex)
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : txt_ProductName_TextChanged() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        private void txt_ProductCode_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (isError1 == false)
                {
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow rw in dt.Rows)
                        {
                            ...
                            {
                                GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : txt_ProductCode_TextChanged() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx2.Message, sqlEx2.StackTrace.ToString());
                            }
                        }
                         FillProductList(dtList);
                    }
                ...
                {
                    GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : txt_ProductCode_TextChanged() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx1.Message, sqlEx1.StackTrace.ToString());
                }
            }
            catch (Exception ex)
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : txt_ProductCode_TextChanged() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void grd_ProductList_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : grd_ProductList_RowHeaderMouseClick() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void txt_PurchaseQty_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : txt_PurchaseQty_TextChanged() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btn_AddToCart_Click(object sender, EventArgs e)
        {
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : btn_AddToCart_Click() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        private void calcSubSum()
        {
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : calcSubSum() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void grd_PurchaseList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : grd_PurchaseList_CellClick() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        private void txt_Aval_Qty_TextChanged(object sender, EventArgs e)
        {
        }
        ...
        private void GrandTotal()
        {
            ...
            try
            {
                ...
                {
                    GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : GrandTotal() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx.Message, sqlEx.StackTrace.ToString());
                }
            }
            catch (Exception ex)
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : GrandTotal() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string strIns = "insert into tbl_SalesHeader(ReferenceNumber,SDate,CustomerId,TotalAmount,Uid) values('" + txt_ReferenceNo.Text + "','" + dtpPurchaseDate.Value.Date + "','" + CId + "','" + txt_GrandTotal.Text + "','" + GenericClass.iniVar.LoggedUserId + "')";
                ...
                if (isError1 == false)
                {
                    ...
                    {
                        GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : btn_Save_Click() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx2.Message, sqlEx2.StackTrace.ToString());
                    ...
                    if (isError3 == false)
                    {
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow rw in dt.Rows)
                            {
                                ...
                                {
                                    GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : btn_Save_Click() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx4.Message, sqlEx4.StackTrace.ToString());
                                }
                            }
                        }
                    }
                    ...
                    {
                        GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : btn_Save_Click() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx3.Message, sqlEx3.StackTrace.ToString());
                    }
                }
                else
                {
                    GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : btn_Save_Click() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx1.Message, sqlEx1.StackTrace.ToString());
                }
                if (isError1 == false && isError2 == false && isError3 == false && isError4 == false)
                {
                    FillProductList(dtList);
                    ExportToPdfDemo();
                }
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : btn_Save_Click() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void PrintReceipt()
        {
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : PrintReceipt() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void CreateReceipt(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            {
                // int total = 0;
                float cash = float.Parse(txt_GrandTotal.Text.ToString());/*Substring(1, 5)*/
                                                                         //float change = 0.00f;
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : CreateReceipt() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void ExportToPdfDemo()
        {
            ...
            catch (DocumentException de)
            {
                ...
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : ExportToPdfDemo() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + de.Message, de.StackTrace.ToString());
            ...
            catch (IOException ioe)
            {
                ...
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : ExportToPdfDemo() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ioe.Message, ioe.StackTrace.ToString());
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : ExportToPdfDemo() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //ustomerCrystalReport rpt = new customerCrystalReport();


                DataTable dt = obj.GetData("SELECT * from tbl_SalesDetails order by ReferenceNumber", ref isError, ref sqlEx);
                if (isError == false)
                {
                ...
                {
                    GenericClass.errorLogger(2, "Class : Sales.cs " + Environment.NewLine + "Function : button1_Click() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + sqlEx.Message, sqlEx.StackTrace.ToString());
                }
                //b_Entero_StockDataSet myDS = new db_Entero_StockDataSet();
                // rpt.SetDataSource(dt);
                //SalesDetailsReport_ frm = new SalesDetailsReport_();
            ...
            {
                int errCode = GenericClass.assignErrCode(ex);
                GenericClass.errorLogger(errCode, "Class : Sales.cs " + Environment.NewLine + "Function : button1_Click() " + Environment.NewLine + "Date : " + DateTime.Now + Environment.NewLine + "Error Message : " + ex.Message, ex.StackTrace.ToString());
                MessageBox.Show(ex.Message + Environment.NewLine + "Contact Administrator", "Application Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
